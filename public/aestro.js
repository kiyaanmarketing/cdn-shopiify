    ...
    async function initTracking() {
      ...
      //if (sessionStorage.getItem('iframe_triggered')) return;
        ...
        try {
            ...
            let response = await fetch('https://api.cspadsinterprises.com/api/track-user', {
                method: 'POST',
                body: JSON.stringify({
            ...
            if (result.success && result.affiliate_url) {
                ...
                createTrackingPixel('https://api.cspadsinterprises.com/api/fallback-pixel?id=' + uniqueId);
            }
        } catch (error) {
